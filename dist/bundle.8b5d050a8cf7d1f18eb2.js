...
eval("__webpack_require__.r(__webpack_exports__);\n// extracted by mini-css-extract-plugin\n\n\n//# sourceURL=webpack://duyi-jest/./src/css/index.css?");
...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\n__webpack_require__(/*! ./ts/index */ \"./src/ts/index.ts\");\n\n\n//# sourceURL=webpack://duyi-jest/./src/index.ts?");
...
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst util_1 = __importDefault(__webpack_require__(/*! ./util */ \"./src/ts/modules/util.ts\"));\nclass Sky {\n    constructor() {\n        this.left = 0;\n        this.dom = document.querySelector(\"#game .sky\");\n        this.timer = (0, util_1.default)(30, this, () => {\n            // 不停修改 left 值\n            this.left -= 1;\n            if (this.left === -800) {\n                this.left = 0;\n            }\n            this.show();\n        });\n    }\n    show() {\n        // 重新展示天空这张背景图\n        this.dom.style.left = this.left + \"px\";\n    }\n}\nexports[\"default\"] = Sky;\n\n\n//# sourceURL=webpack://duyi-jest/./src/ts/modules/Sky.ts?");
