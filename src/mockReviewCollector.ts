...
console.log(reviewCollector.getNumGoodReviews('小米手表')); // 2
console.log(reviewCollector.getNumGoodReviews('苹果手机')); // 1
console.log(reviewCollector.getNumGoodReviews('海豚音响')); // 0
